            ...
            {isOpen && (
                <ul className="md:hidden flex flex-col items-center list-none p-0 m-0 bg-blue-600">
                    <li className="w-full text-center">
                        <Link href="/" className="block text-white no-underline p-2 hover:border-b-2 hover:border-gray-300" onClick={toggleMenu}>
                            Accueil
                        </Link>
                    </li>
                    <li className="w-full text-center">
                        <Link href="/create-event" className="block text-white no-underline p-2 hover:border-b-2 hover:border-gray-300" onClick={toggleMenu}>
                            Créer un Événement
                        </Link>
                    </li>
                    <li className="w-full text-center">
                        <Link href="/list-events" className="block text-white no-underline p-2 hover:border-b-2 hover:border-gray-300" onClick={toggleMenu}>
                            Liste des Événements
                        </Link>
                    </li>
                    <li className="w-full text-center">
                        <Link href="/verify-nft" className="block text-white no-underline p-2 hover:border-b-2 hover:border-gray-300" onClick={toggleMenu}>
                            Vérifier un NFT
                        </Link>
                    </li>
